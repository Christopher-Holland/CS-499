...
public class Driver {
   ...
   public static void initializeDogList() {
      Dog dog1 = new Dog("Kiwi", "German Shepherd", "female", "4", "27.5", "05-12-2019", "America", "farm", false, "America");
      Dog dog2 = new Dog("Ozzy", "Great Dane", "male", "1", "35.2", "03-18-2023", "America", "Phase II", false, "America");
      Dog dog3 = new Dog("Bruno", "Rotteiler", "male", "4", "25.6", "12-12-2019", "Mexico", "in service", true, "Mexico");
   ...
   public static void initializeMonkeyList() {
      Monkey monkey1 = new Monkey("Coco", "Capuchin", "male", "1", "5.6", "15", "10", "5", "05-21-2021", "United States", "intake", false, "United States");
      Monkey monkey2 = new Monkey("George", "Macaque", "male", "3", "15.2", "63", "53", "10", "02-29-2002", "United States", "Phase I", false, "United States");
      Monkey monkey3 = new Monkey("Herambe", "Tamarin", "female", "4", "1.6", "9", "1", "0.6", "12-21-2012", "Canada", "in service", false, "Canada");
   ...
   public static void intakeNewMonkey(Scanner scanner) {
      ...
      System.out.println("What is " + name + "'s tail length? (in inches)");
   ...
   public static void printAnimals(String outputType) {
      ...
      // and reserve status
      System.out.printf("%-8.10s\t| %-1.10s\t| %-1.10s\t| %s%n", "Name", "Status", "Acq. Country", "Reserved");
      ...
      switch(outputType) {
         ...
         case "available":
            ...
            for(Dog dog : dogList) {
               ...
               System.out.printf("%-8.10s\t| %-1.10s\t| %-1.10s\t| %s%n%n", name, status, acquisitionCountry, reserved);
            }
